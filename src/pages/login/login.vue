	...
	<view>
		...
		<view class="login-view" style="">
			<view class="t-login">
				...
				<van-divider>其他账户登录</van-divider>
				<view class="t-e cl">
					<view class="t-g" @tap="wxLogin()"><image src="@/static/images/wx.png"></image></view>
					<view class="t-g" @tap="zfbLogin()"><image src="@/static/images/qq.png"></image></view>
				</view>
			</view>
		</view>
	</view>
